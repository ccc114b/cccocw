...
Docker 是一個開源容器化平台，將應用程式及其相依環境封裝為可攜式容器，實現「建置一次，到處執行」的目標。
...
- 相關主題：[容器編排](../../../軟體工程/主題/容器編排.md) - Kubernetes 管理多容器
- 相關主題：[持續整合](../../../軟體工程/主題/持續整合.md) - CI/CD 中的 Docker 使用
- 相關主題：[雲端原生](../../../軟體工程/主題/雲端原生.md) - 雲端容器化應用
